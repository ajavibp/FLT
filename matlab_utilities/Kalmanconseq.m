function [Model, P, err] = Kalmanconseq(Model, inputs, outputs, covariance, P)
% KALMANCONSEQ. Calculates an iteration of EKF only for consequents.
%
%   [Model, P, err] = Kalmanconseq(Model, inputs, outputs, covariance, P)
%
%   [Model, P, err] = Kalmanconseq(Model, inputs, outputs, covariance, P, Phi)
%
% Arguments:
% 
