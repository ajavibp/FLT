% FUZDERAFFINE Gets the derivative of a fuzzy model respect its affine consequents.
%
...
%
%   dh_daffine = fuzderaffine(Fuzzy_Model, Point)
%
%   dh_dconseq = fuzderaffine(Fuzzy_Model, Point, out, rule)
%
% Arguments:
%
...
%          fuz2mat, fuzcomb, fuzderantec, fuzderconseq, fuzderparam, fuzeval, fuzjac, fuzlinear,
