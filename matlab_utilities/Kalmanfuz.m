function [Model, P, err] = Kalmanfuz(Model, inputs, outputs, covariance, P)
% KALMANFUZ. Calculates an iteration of EKF for antecedents and consequents.
%
%   [Model, P, err] = Kalmanfuz(Model, inputs, outputs, covariance, P)
%
%   [Model, P, err] = Kalmanfuz(Model, inputs, outputs, covariance, P, Phi)
%
% Arguments:
% 
...
%
% See also Kalmanantec, Kalmanconseq, activation, antec2mat, aproxjac
%          aproxlinear, conseq2mat, fis2txt, fuz2mat, fuzcomb, fuzeval, fuzjac,
%          fulinear, fuzprint, mat2antec, mat2conseq, mat2fuz, fuzsubsystem,
%          txt2fis
